...
function AddPolicyType() {
    ...
    return (
        <section className="container-fluid relative flex p-0 sm:ml-64 bg-white">
            ...
            <h1 className="font-semibold text-3xl my-2 text-orange-700">Add Policy Type</h1>
                ...
                <div className="inline-block min-w-full w-full py-0  overflow-x-auto">
                    <h1 className="font-semibold text-3xl my-2 text-orange-700">Policy Type Lists</h1>
                    <table className="min-w-full text-center text-base font-light table bg-slate-200 rounded-lg">
                        <thead className="border-b font-medium dark:border-neutral-200 ">
                            <tr className="text-blue-700 border border-black">
                                ...
                                <th scope="col" className="border border-black px-1 py-1">
                                    Policy Type
                                </th>
                                {/* <th scope="col" className="px-5 py-4">
                                    Update

    ...
    <>
      ...
      <div
        ...
        <div className="relative p-1 w-1/3  mx-auto my-40">
          {/* <!-- Modal content --> */}
          <div className="p-2 relative bg-gradient-to-r from-orange-700 to-orange-700 rounded-lg shadow dark:bg-slate-100">
            {/* <!-- Modal header --> */}
            ...
            {/* <!-- Modal body --> */}
            <section className="p-1 md:p-1  rounded-lg max-h-auto text-justify overflow-y-auto bg-gradient-to-r from-orange-700 to-orange-700">
              {/* <div className="container-fluid flex justify-center p-1 border-gray-200 border-dashed rounded-lg dark:border-gray-700 bg-orange-700"> */}

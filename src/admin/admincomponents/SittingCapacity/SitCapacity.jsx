...
const updateSeat = async () => {
  ...
  return (
    <section className="container-fluid relative h-screen p-0 sm:ml-64 bg-white">
      ...
      <h1 className="font-semibold text-3xl my-3">Seating Capacity</h1>
        <div className="relative w-full lg:w-full  p-0 lg:p-4  rounded-xl shadow-xl text-2xl  items-center bg-gradient-to-r from-slate-200 to-slate-200">

      ...
      <section className="container-fluid h-screen relative bg-orange-500">
        <div className="container-fluid pt-5 flex flex-col md:flex-row items-center  justify-between bg-orange-500">
          ...
          <div className="flex-shrink-1 px-32  md:h-full h-full w-full xs:w-full  -mt-20 sm:w-full md:1/2 mx-auto lg:w-1/2 xl:w-1/2 xl:py-10">
            <div className="w-full max-w-xl p-6 space-y-6 sm:p-10 bg-white rounded-lg shadow text-black ">
              ...
              >
                <div className="">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    className="bg-gray-200 border border-gray-50 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 active:placeholderbg-gray-400focus:border-primary-500 block w-full p-2.5 "
                ...
                <div className=" text-end text-sm text-black m-0 ">
                  ...
                  <NavLink to="/admin" className="ml-2 font-semibold text-red-700 hover:text-red-500">
                    Sign in
                  </NavLink>
                </div>

...
// import '/policy-bazaar/src/employee/EmpAttendance.css';
...
function EmpAttendance() {
  ...
  const markAttendance = async (status) => {
    ...
    if (
      ...
      console.log('Cannot mark attendance for past or future dates.');
      // Optionally, you can provide a user-friendly message or take other actions.
    }
  };

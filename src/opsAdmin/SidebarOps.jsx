                ...
                {route.subRoutes ? (
                  ...
                  <div className="relative group">
                    <NavLink
                      ...
                      className={`flex items-center p-2  rounded-lg text-white hover:bg-slate-800 group ${openSubmenu === idx ? "bg-slate-800" : ""}`}
                    >
                    ...
                    >
                      {route.subRoutes.map((subRoute, subIdx) => (
                        <li key={subIdx}>
                          <NavLink
                            to={subRoute.path}
                            className="block p-2 ms-4 text-sm text-white text-start mx-8  hover:rounded-xl hover:bg-slate-800"
                          >
                            {subRoute.title}
                          </NavLink>
                        </li>

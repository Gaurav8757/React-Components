    ...
    return <>
        <div className="container-fluid relative bg-white " >
            <div className="container-fluid  flex justify-around items-center ml-2 mr-2   bg-white  ">
                {/* part-1 */}
                <div className=" col ml-4 mb-4 flex justify-center  md:block relative  ">
                <img src="/logo.jpg " className="xl:w-78 xl:h-32 h-auto max-w-lg mx-auto" alt="Logo" />
                <span className="self-center xs:text-2xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-3xl font-semibold  whitespace-nowrap font-sans ">Eleedom IMF Private Limited</span>
                    ...
                    {/* h-auto  xs:h-12 sm:h-12 md:h-16   lg:h-16    mx-2 w-28 sm:w-28 md:w-28 lg:w-auto  */}

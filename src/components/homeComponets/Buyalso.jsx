...
const Buyalso = ({ buyalso }) => {
    ...
    return (
        <section className="container-fluid  bg-gradient-to-r from-indigo-500 to-cyan-400">
            <div className=" pt-10 ml-2 mr-2  bg-gradient-to-r from-indigo-500 to-cyan-400 flex justify-start ">
                <div className="text-black text-2xl font-semibold pb-8 ml-12 ">ALSO BUY</div>
            </div>
            <div className="grid grid-cols-2 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 shadow-xl gap-8 justify-items-center pb-12 bg-gradient-to-r from-indigo-500 to-cyan-400 ">

...
const Buyalso = ({ buyalso }) => {
    ...
    return (
        <section className="container-fluid  bg-gradient-to-r from-indigo-300 to-cyan-400">
            ...
            <div className="grid grid-cols-2 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 shadow-xl gap-8 justify-items-center ml-2 mr-2 pb-12 bg-gradient-to-r from-indigo-300 to-cyan-400 ">

                {
                    buyalso.map((obj, idx) => (
                        // adding link to click
                        <NavLink to="#" className="grid w-48 p-1 hover:-translate-y-1 hover:-translate-x-0  bg-gradient-to-r from-purple-100 to-cyan-200 rounded-lg  hover:shadow-none  shadow-2xl   " key={idx}>
                            {/* home links */}
                            ...
                            <p className="text-md justify-items-start p-2 ">{obj.name}</p>
                        </NavLink>
                    ))
                }
            </div>

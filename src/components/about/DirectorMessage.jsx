        ...
        <section className="container-fluid relative bg-slate-500">
            <div className="container-fluid  h-3/4 items-center  ml-2 mr-2 pb-4  bg-slate-100  ">
                ...
                <form className="max-w-sm mx-auto border bg-slate-300 rounded-xl p-4 mb-14">
                    ...
                    <input type="text" id="small" value={topic} onChange={(e)=> setTopic(e.target.value)} className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500  dark:border-gray-600 dark:placeholder-gray-900  dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder:text-gray-900  " placeholder="Enter your topic..."/>
                    <label htmlFor="message" className="block mb-2 text-md font-medium text-gray-900 ">Your message</label>
                    <textarea id="message" rows="4" value={query} onChange={(e)=> setQuery(e.target.value)}  className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500  dark:border-gray-600   dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder:text-gray-900" placeholder="Leave a messages..."></textarea>
                    <br></br>

    ...
    return (
        <section className="container-fluid relative bg-gradient-to-r from-indigo-400 to-cyan-400">
            <div className="container-fluid h-3/4 items-center ml-2 mr-2 pb-4 bg-gradient-to-r from-indigo-400 to-cyan-400">
                ...
                <div className="flex flex-col lg:flex-row justify-center lg:justify-evenly text-justify shadow-sm p-10 items-center">
                    ...
                    <h1 className="text-4xl mb-10 text-white font-medium text-center">Mission</h1>
                ...
                <div className="flex flex-col lg:flex-row justify-center lg:justify-evenly text-justify shadow-2xl p-10 items-center">
                    <div className="max-w-lg text-base lg:max-w-3xl sm:max-w-lg md:max-w-xl xl:max-w-3xl ">
                    <h1 className="text-4xl mb-10 text-white font-medium text-center">Vision</h1>

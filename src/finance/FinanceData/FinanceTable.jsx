    ...
    <div className="inline-block min-w-full w-full py-0 relative">
      <table className="min-w-full text-center text-sm font-light table border border-black">
        ...
        Update
              ...
              <td className="whitespace-wrap px-1 py-1 border border-black">{data.vehRegNo}</td>
              ...
              <td className="whitespace-wrap px-1 py-1 border border-black">{data.engNo}</td>
              <td className="whitespace-wrap px-1 py-1 border border-black">{data.chsNo}</td>
              ...
              <td className="whitespace-wrap px-1 py-1 border border-black">{data.makeModel}</td>

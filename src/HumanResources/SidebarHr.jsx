    ...
    const dashboardRouted = [
      ...
      return (
        <>
          ...
          <aside
            id="logo-sidebar"
            className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} bg-gradient-to-r from-black to-slate-500 border-r   sm:translate-x-0 `}
            aria-label="Sidebar"
          >

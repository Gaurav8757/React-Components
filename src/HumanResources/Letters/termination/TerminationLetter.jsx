...
function TerminationLetter({ terminate }) {
                                ...
                                <div className=" max-w-auto bg-gradient-to-br from-red-100 to-red-200  p-4 print" ref={componentRef}>
                                    ...
                                    <section className="">
                                        ...
                                        <p className=' p-4 text-start'>
                                            Subject:- <span className='font-bold'>Termination of Employment</span>
                                        </p>
                                        <p className="mb-4 p-4 leading-8 text-justify">
                                            <span className='font-semibold'>Dear {terminate.empname},</span><br />
                                            I am writing to inform you that, unfortunately, your employment with <b>Eleedom IMF Pvt. Ltd.</b> will be terminated effective {terminate.terminatedate}. This decision was made after careful consideration and evaluation of various factors.
                                            <br />
